...
@Component({
  selector: 'app-estimate-download',
  templateUrl: './estimate-download.component.html',
  styleUrls: ['./estimate-download.component.scss']
})
export class EstimateDownloadComponent implements OnInit, AfterViewChecked {
