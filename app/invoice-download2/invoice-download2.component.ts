...
@Component({
  selector: 'app-invoice-download2',
  templateUrl: './invoice-download2.component.html',
  styleUrls: ['./invoice-download2.component.scss']
})
export class InvoiceDownload2Component implements OnInit {
